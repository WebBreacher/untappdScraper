...
if when:
    ...
    print '         08:00 (%2d) : %s' % (h8, h8*'x')
    print '         09:00 (%2d) : %s' % (h9, h9*'x')
    print '         10:00 (%2d) : %s' % (h10, h10*'x')
    print '         11:00 (%2d) : %s' % (h11, h11*'x')
    print '         12:00 (%2d) : %s' % (h12, h12*'x')
    print '         13:00 (%2d) : %s' % (h13, h13*'x')
    print '         14:00 (%2d) : %s' % (h14, h14*'x')
    print '         15:00 (%2d) : %s' % (h15, h15*'x')
    print '         16:00 (%2d) : %s' % (h16, h16*'x')
    print '         17:00 (%2d) : %s' % (h17, h17*'x')
    print '         18:00 (%2d) : %s' % (h18, h18*'x')
    print '         19:00 (%2d) : %s' % (h19, h19*'x')
    print '         20:00 (%2d) : %s' % (h20, h20*'x')
    print '         21:00 (%2d) : %s' % (h21, h21*'x')
    print '         22:00 (%2d) : %s' % (h22, h22*'x')
    print '         23:00 (%2d) : %s' % (h23, h23*'x')
    print '         00:00 (%2d) : %s' % (h0, h0*'x')
    print '         01:00 (%2d) : %s' % (h1, h1*'x')
    print '         02:00 (%2d) : %s' % (h2, h2*'x')
    print '         03:00 (%2d) : %s' % (h3, h3*'x')
    print '         04:00 (%2d) : %s' % (h4, h4*'x')
    print '         05:00 (%2d) : %s' % (h5, h5*'x')
    print ''
