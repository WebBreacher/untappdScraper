...
var sortMoments = function sortMoments(a, b) {
  var aUnix = a.unix();
  var bUnix = b.unix();
...
var sortVisitDates = function sortVisitDates(a, b) {
  ...
  if (a.lastVisitDate && b.lastVisitDate) {
    return sortMoments(moment_timezone__WEBPACK_IMPORTED_MODULE_18__(a.lastVisitDate), moment_timezone__WEBPACK_IMPORTED_MODULE_18__(b.lastVisitDate));
  }
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Index, [{
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        data: this.state.data.recentActivity.sort(function (a, b) {
          return sortMoments(a.time, b.time);
        }),
        ...
        title: "Venues: ",
        data: this.state.data.venues.sort(sortVisitDates),
        valueFormatter: function valueFormatter(params) {
          var columnName = params.column.colId;

          if (columnName === 'firstVisitDate') {
            return params.value ? moment_timezone__WEBPACK_IMPORTED_MODULE_18__(params.value).format(dateFormat) : undefined;
          }

          if (columnName === 'lastVisitDate') {
            return moment_timezone__WEBPACK_IMPORTED_MODULE_18__(params.value).format(dateFormat);
          }

          if (columnName === 'geocode') {
            return "".concat(params.value[0].geometry.location.lat(), ", ").concat(params.value[0].geometry.location.lng());
          }
        ...
        title: "Beers:",
        data: this.state.data.beers.sort(function (a, b) {
          return sortMoments(a.firstDrinkTime, b.firstDrinkTime);
        }),
        valueFormatter: function valueFormatter(params) {
          var columnName = params.column.colId;
...
//# sourceMappingURL=index.js.efc6910ee9c5e772f4b2.hot-update.js.map