...
var analyzeBeers = function analyzeBeers(beers, recentActivity) {
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var _beer = _step2.value;
      uniqueDrinkTimes.push(_beer.firstDrinkTime);
      uniqueDrinkUnixTimestamps.push(_beer.firstDrinkTime.unix());
      updateDrinkHistogram(beerAnalytics, _beer.firstDrinkTime);

      if (_beer.firstDrinkTime.diff(_beer.lastDrinkTime) !== 0) {
        uniqueDrinkTimes.push(_beer.lastDrinkTime);
        uniqueDrinkUnixTimestamps.push(_beer.lastDrinkTime.unix());
        updateDrinkHistogram(beerAnalytics, _beer.lastDrinkTime);
      }
    }
  } catch (err) {
    _iterator2.e(err);
  ...
  for (var activity in recentActivity) {
    ...
    if (!uniqueDrinkUnixTimestamps.includes(time.unix())) {
  ...
  */
  ...
  var potentialBinge = [];
  var twoHoursSeconds = 60 * 60 * 2;

  var _iterator3 = _createForOfIteratorHelper(uniqueDrinkTimesSorted),
      _step3;

  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      var drinkTime = _step3.value;
  ...
  var _iterator4 = _createForOfIteratorHelper(beerAnalytics.binges),
      _step4;

  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
      var binge = _step4.value;
...
var geocodeAddresses = function geocodeAddresses(googleMapsClient, venues) {
  var geocoder, promises, _iterator5, _step5, venue;
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 2:
          ...
          promises = [];
          _iterator5 = _createForOfIteratorHelper(venues);
...
var displayGoogleMap = function displayGoogleMap(googleMapsClient, venues) {
  ...
  var _iterator6 = _createForOfIteratorHelper(venues),
      _step6;

  try {
    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
      var venue = _step6.value;
...
//# sourceMappingURL=index.js.409ac6d4a44396cbe32c.hot-update.js.map