...
var analyzeBeers = function analyzeBeers(beers, recentActivity) {
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      uniqueDrinkStrings.push(beer.firstDrinkTime.format());
      ...
      if (beer.firstDrinkTime.diff(beer.lastDrinkTime) !== 0) {
        ...
        uniqueDrinkStrings.push(beer.lastDrinkTime.format());
  ...
  for (var activity in recentActivity) {
    ...
    if (!uniqueDrinkStrings.includes(time.format())) {}
  }
...
//# sourceMappingURL=index.js.177468072b9ecda2be74.hot-update.js.map