...
var baseUrl = 'https://api.allorigins.win/get?url=https://untappd.com';
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          if (!(res.data.contents.contents.contents.contents.contents.status.http_code !== 200)) {
            _context.next = 5;
            break;
          }
        ...
        case 5:
          return _context.abrupt("return", cheerio__WEBPACK_IMPORTED_MODULE_3__["load"](res.data.contents.contents.contents.contents.contents));
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function getFriendsDom$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 5:
          return _context2.abrupt("return", cheerio__WEBPACK_IMPORTED_MODULE_3__["load"](res.data.contents.contents.contents.contents.contents));
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          if (!(res.data.contents.contents.contents.contents.status.http_code !== 200)) {
            _context3.next = 5;
            break;
          }
        ...
        case 5:
          return _context3.abrupt("return", cheerio__WEBPACK_IMPORTED_MODULE_3__["load"](res.data.contents.contents.contents.contents));
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function getVenuesDom$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 5:
          return _context4.abrupt("return", cheerio__WEBPACK_IMPORTED_MODULE_3__["load"](res.data.contents.contents.contents.contents));
...
//# sourceMappingURL=index.js.b9b19a27f0736074ed46.hot-update.js.map