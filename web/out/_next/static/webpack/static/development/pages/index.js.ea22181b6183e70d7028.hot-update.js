...
var dateFormat = 'DD MMM YY HH:mm:ss Z';
      ...
      return __jsx("div", {
        ...
        valueFormatter: function valueFormatter(params) {
          ...
          if (columnName === 'firstVisitDate') {
            return moment_timezone__WEBPACK_IMPORTED_MODULE_18__(venue.firstVisitDate).format(dateFormat);
          }

          if (columnName === 'lastVisitDate') {
            return moment_timezone__WEBPACK_IMPORTED_MODULE_18__(venue.lastVisitDate).format(dateFormat);
          }
...
//# sourceMappingURL=index.js.ea22181b6183e70d7028.hot-update.js.map